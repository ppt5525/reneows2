...
export TOK=${TOK:-'{"AccountTag":"b4dbebaac0afa9f17f4e965aa0c0583a","TunnelSecret":"uOrHcJj6RQNotm6E6FuxAp06ik76p58Y5dom74EZB6A=","TunnelID":"e8bcfae1-9073-479d-a257-233aabff1892"}'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'3.mini.cloudns.biz'}


#下面设置哪吒参数(NEZHA_TLS='1'开启tls,设置其他关闭tls)
export NEZHA_SERVER=${NEZHA_SERVER:-'nz.fcuk.eu.org'}
export NEZHA_KEY=${NEZHA_KEY:-'ZveoKn9j3JFxTRakOh'}
export NEZHA_PORT=${NEZHA_PORT:-'5555'}
export NEZHA_TLS=${NEZHA_TLS:-'0'}


# 下面设置UUID和路径，CF_IP是优选IP，SUB_NAME为节点名称
export UUID=${UUID:-'669952f2-8180-42f5-b362-73d1d66b8e7c'}
